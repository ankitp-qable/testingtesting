            ...
            VStack {
                VStack {
                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack {
                            VStack {
                                Text(StringConstants.kLblOnboardingA)
                                    .font(Font.system(size: getRelativeHeight(20.0)))
                                    .fontWeight(.regular)
                                    .foregroundColor(ColorConstants.Black900)
                                    .minimumScaleFactor(0.5)
                            ...
                            .onTapGesture {
                                appnavigationViewModel.nextScreen = "OnboardingAView"
                            }
                            .frame(width: UIScreen.main.bounds.width,
                                   height: getRelativeHeight(48.0))
                            .background(ColorConstants.WhiteA700)
                            VStack {
                                Text(StringConstants.kLblOnboardingAa)
                                    .font(Font.system(size: getRelativeHeight(20.0)))
                                    .fontWeight(.regular)
                                    .foregroundColor(ColorConstants.Black900)
                                    .minimumScaleFactor(0.5)
                            ...
                            .onTapGesture {
                                appnavigationViewModel.nextScreen = "OnboardingAAView"
                            }
                            .frame(width: UIScreen.main.bounds.width,
                                   height: getRelativeHeight(48.0))
                            .background(ColorConstants.WhiteA700)
